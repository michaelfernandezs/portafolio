...
const Navbar=()=>{
    ...
    <div  className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-gradient-to-r from-blue-600 to-blue-900">
    ...
    return(
       <nav>
        <div className="h-10vh flex  justify-between z-50 text-white lg:py-5 px-20 py-4 border-b border-slate-900 bg" >
        ...
        <div className="lg:flex md:flex lg: flex-1 items center justify-end font-normal hidden" >
            ...
            <Link spy={true} smooth={true} to="Contact">
            <li className="hover:text-fuchsia-600 transition border-b-2 border-slate-500 hover:border-fuchsia-600 cursor-pointer"> Contact </li>
            </Link>
